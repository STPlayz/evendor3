...
export default function ProductsUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setBidding_price_min(cleanValues.bidding_price_min);
    setBidding_price_current(cleanValues.bidding_price_current);
    setBuy_now_price(cleanValues.buy_now_price);
  ...
  return (
    ...
    >
      ...
      <TextField
        ...
        type="number"
        step="any"
        defaultValue={bidding_price_min}
        onChange={(e) => {
      ...
      <TextField
        ...
        type="number"
        step="any"
        defaultValue={bidding_price_current}
        onChange={(e) => {
          let value = parseInt(e.target.value);
          if (isNaN(value)) {
            setErrors((errors) => ({
